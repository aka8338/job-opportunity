...
const WELLCOME_EMAIL_TEMPLATE = `<!-- Change values in the template and pass { {variables} } with API call -->
      ...
      <tr>
        <td valign="top" align="center">
          <table class="container" width="600" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 22px; color: #4C83EE;">
                  As Company
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>As Company</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0;  text-align: center; width:100%;">
                    <a style="padding: 0; font-size: 14px; line-height: 15px; font-weight: normal; color: #8B949F;">Unsubscribe</a>
                  </div>
