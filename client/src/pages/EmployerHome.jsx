...
>>>>>>> 5d431ff399152b36ec0c8849755d26b5d7dad47b
        ...
        <nav className="flex items-center">
          <div className="hidden md:flex space-x-4">
            <ul className="flex space-x-4">
              <li>
                <Link to="#" className="hover:text-green-600 text-2xl">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/jobs" className="hover:text-green-600 text-2xl">
                  Jobs
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/profile" className="hover:text-green-600 text-2xl">
                  Profile
                </Link>
              </li>
            </ul>
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-200 p-4">
          <ul className="flex flex-col space-y-2">
            <li>
              <Link to="#" className="block hover:text-green-600 text-xl">
                Home
              </Link>
            </li>
            <li>
              <Link to="/jobs" className="block hover:text-green-600 text-xl">
                Jobs
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link
                to="/profile"
                className="block hover:text-green-600 text-xl"
              >
                Profile
              </Link>
            </li>
...
>>>>>>> 5d431ff399152b36ec0c8849755d26b5d7dad47b
      ...
      <main className="flex-grow flex flex-col items-center justify-center bg-gray-100 p-8">
        ...
        <p className="text-lg text-gray-700 leading-relaxed sm:text-xl md:text-2xl max-w-2xl mx-auto p-4 sm:p-6 md:p-8">
          We are glad to have you onboard! This platform empowers employers like
          you to connect with talented applicants, post job openings, and manage
          your hiring process effortlessly. Explore the features designed to
          streamline your recruitment efforts and enhance your organizational
          impact.
        </p>
