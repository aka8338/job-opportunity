  ...
  return (
    <div className="flex flex-col md:flex-row justify-between p-8 bg-gray-100">
      <div className="contact-form-section bg-white p-6 rounded-lg shadow-md md:w-1/2 mr-4">
        <h2 className="form-header text-2xl font-bold mb-4">
        ...
        <form className="contact-form space-y-4">
          ...
          <button
            type="submit"
            className="submit-btn w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600"
          >
            Send Message
          </button>
        </form>
      ...
      <div className="contact-info-section bg-white p-6 rounded-lg shadow-md md:w-1/3 ml-4 mt-6 md:mt-0">
        ...
        <p className="mb-4">
          ...
          need assistance with a transaction, or just want to share your
          thoughts, we’d love to hear from you. Feel free to reach out, and our
          team will get back to you as soon as possible. Your feedback is
          essential in helping us create the best experience for you. Lets make
          your journey smoother together!
        </p>
